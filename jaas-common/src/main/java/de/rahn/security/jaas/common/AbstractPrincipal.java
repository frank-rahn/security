...
public abstract class AbstractPrincipal
    implements Principal, Serializable, Comparable<AbstractPrincipal> {

  /** serialVersionUID */
  private static final long serialVersionUID = 1L;

  /** Attribute, die zu exkludieren sind. */
   ...
   * @throws IllegalArgumentException, falls der Name nicht angegeben ist oder nur aus Whitespaces
   *     besteht
   */
