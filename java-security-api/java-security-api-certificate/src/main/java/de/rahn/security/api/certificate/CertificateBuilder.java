...
public abstract class CertificateBuilder implements CertificateHolder {
   ...
   * @param cn der "Common Name" des Zertifikatsinhabers
   * @throws Exception, falls ein Fehler beim Erzeugen der Security-Objekte auftritt
   */
  public CertificateBuilder(KeyStore keyStore, BigInteger serialNumber, String cn)
      throws Exception {
    super();
  ...
  public CertificateHolder build() throws Exception {
    ...
    keyStore.setKeyEntry(
        getAlias(), keyPair.getPrivate(), PASSWORD.toCharArray(), new Certificate[] {certificate});
   ...
   *
   * @throws GeneralSecurityException, falls ein Fehler beim Erzeugen der Security-Objekte auftritt
   */
   ...
   */
  protected JcaX509v3CertificateBuilder buildCertificateBuilder(X500Name issuer) {
   ...
   * @throws OperatorException, falls der Unterzeichner nicht erstellt werden kann
   */
