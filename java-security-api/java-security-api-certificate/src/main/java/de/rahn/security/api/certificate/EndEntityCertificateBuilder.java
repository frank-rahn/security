...
public class EndEntityCertificateBuilder extends CertificateBuilder {
   ...
   */
  public EndEntityCertificateBuilder(
  ...
  protected X509Certificate buildCertificate() throws Exception {
    ...
    builder.addExtension(basicConstraints, true, new BasicConstraints(false));
    builder.addExtension(keyUsage, true, new KeyUsage(digitalSignature | keyEncipherment));
