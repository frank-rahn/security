  ...
  public void run() {
    ...
    try {
      for (String algorithm : asList("AES", "Blowfish")) {
        appendTitle("Symmetrische Verschlüsselung - Blockchiffre - " + algorithm);
        ...
        appendDesc("Verschlüsselungsverfahren")
            ...
            .appendValue("ExemptionMechanism", encrypt.getExemptionMechanism())
            .appendValue("Classname", encrypt.getClass().getName())
            .appendToString(encrypt)
            .appendln();
        ...
        appendDesc("Entschlüsselungsverfahren")
            ...
            .appendValue("ExemptionMechanism", decode.getExemptionMechanism())
            .appendValue("Classname", decode.getClass().getName())
            .appendToString(decode)
            .appendln();
        ...
        appendDesc("Entschlüsselung:")
            ...
            .appendValue("Output Text", new String(decodeBytes, StandardCharsets.UTF_8))
            .appendln();
      }
